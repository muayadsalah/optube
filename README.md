...
This application was generated using JHipster 6.9.1, you can find documentation and help
at [https://www.jhipster.tech/documentation-archive/v6.9.1](https://www.jhipster.tech/documentation-archive/v6.9.1).
...
To build the final jar and optimize the optube application for production, run:
